...
contract data_transaction {
    ...
    function uploadData(string memory data_hash, string memory dataset_name, string memory data_category,uint price, bool purchase_ML, string memory data_description) public payable {
